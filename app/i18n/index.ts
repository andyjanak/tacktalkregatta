...
// ---------------------------------------------------------------------------
export type RouteKey = "home" | "weather" | "results" | "documents" | "partners" | "boats";
...
// Stránka výsledkov — lokalizovaný slug (napr. /vysledky, /en/results).
export function localeResults(locale: Locale): string {
  return routePath("results", locale);
}

// Stránka dokumentov — lokalizovaný slug (napr. /dokumenty, /en/documents).
export function localeDocuments(locale: Locale): string {
...
// Stránka lodí — lokalizovaný slug (napr. /lode, /en/boats, /de/boote).
export function localeBoats(locale: Locale): string {
  return routePath("boats", locale);
}
...
export const boatsAlternates = routeAlternates("boats");
